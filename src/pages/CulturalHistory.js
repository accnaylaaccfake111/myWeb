        ...
        if (line.startsWith("**Cái kể**:")) {
          return (
            <p
              ...
              style={{ animationDelay }}
            >
              <span className="text-red-700 font-semibold">Cái kể:</span>
        ...
        if (line.startsWith("**Con xô**:")) {
          return (
            <p
              ...
              style={{ animationDelay }}
            >
              <span className="text-blue-700 font-semibold">Con xô:</span>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        {/* Layout mới khi thẻ mở*/}
                        {expandedCard === uniqueId && (
                          <div className="expanded-layout">
                            {/* Ảnh nhỏ hơn một chút xíu */}
                            ...
                            <div className="text-gray-600 expanded-content">
                              <div className="mb-6 lyric-container">
                                <h4 className="text-xl font-semibold text-red-700 mb-4 section-title">
                                  Lời bài hát
                                </h4>
